...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, hora: @evento.hora, titulo: @evento.titulo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, hora: @evento.hora, titulo: @evento.titulo } }
