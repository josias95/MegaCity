...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { estado: @factura.estado, valor: @factura.valor } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { estado: @factura.estado, valor: @factura.valor } }
